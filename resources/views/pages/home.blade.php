...
<x-alerts.message/>
    ...
    <section class="bg-own-lightgray">
            {{-- úvod --}}
        <main class="relative border border-black-custom">

            <div class="hidden md:flex ">
                <x-home.introduction.content-pc/>
            </div>

            <div class="block md:hidden ">
                <x-home.introduction.content-mobile/>
            </div>
    ...
    {{-- služby --}}
        ...
        <main class="relative">
            ...
            <div class="hidden md:flex justify-center bg-own-darkgray ">
                <x-home.us.content-pc/>
            </div>

            <div class="block md:hidden ">
                <x-home.us.content-mobile/>
            </div>

        </main>

    {{-- leaderboard --}}
        <section class="relative border border-black-custom">
