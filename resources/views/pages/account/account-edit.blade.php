                                        ...
                                        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                                <div class="overflow-hidden">
                                                    ...
                                                    <table class="min-w-full divide-y divide-black-custom">
                                                        <thead class="bg-own-darkgray">
                                                            <h1 class="text-white font-bold text-xl font-poppins"> Hlavní účet</h1>
                                                    ...
                                                    <table class="min-w-full divide-y divide-black-custom ">
                                                        <thead class="bg-own-darkgray">
                                                            <h1 class="text-white font-bold text-xl font-poppins mt-10"> Další účty</h1>
