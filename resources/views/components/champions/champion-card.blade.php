            ...
            <div class="flex flex-col items-center h-full justify-evenly py-6 ">
                ...
                <div class=" h-full">
                    ...
                    <div class="flex justify-center py-4">
                        <img style="width: 90px" src="{{ $champion->getFirstMediaUrl('avatars') }}">
                    </div>
                    {{-- name + title --}}
                    <div class="text-center ">
                        ...
                        @foreach (json_decode($champion->tags) as $tag)
                            ...
                            @elseif ($tag == 'Tank')
                                ...
                                <svg width="20" height="20" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M8.17128 16C4.22166 12.8 2.41142 6.13336 2 3.2C4.63308 2.56 6.93703 0.8 7.75986 0L8.17128 10.4L8.99412 0.8C9.98153 2.08 12.6969 2.93334 13.9311 3.2C14.5894 7.68 10.3655 13.6 8.17128 16Z"
                                        fill="#B3B4D0" />
                                </svg>
                                {{-- Mage --}}
                            @elseif ($tag == 'Mage')
                            ...
                            @elseif ($tag == 'Assassin')
                                ...
                                <svg width="20" height="20" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M5.25806 11.4949C6.67742 8.06061 8.68815 7.0303 9.51613 6L11.6452 8.06061L8.80645 10.1212C9.51613 10.8081 11.2081 10.6936 12 10.4646C7.45806 15.9596 2.65591 15.3872 1 14.2424C2.06452 14.0135 4.49782 13.3344 5.25806 11.4949Z"
                                        fill="#B3B4D0" />
                                    <path
                                        d="M16 2.89474L13.913 1L11.1304 3.84211L9.04348 2.89474L8 3.52632L13.913 7L14.6087 6.36842L12.1739 4.47368L16 2.89474Z"
                                        fill="#B3B4D0" />
                                </svg>
                                {{-- Marksman --}}
                            @elseif ($tag == 'Marksman')
