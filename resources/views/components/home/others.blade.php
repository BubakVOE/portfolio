<section class="relative  bg-own-darkgray">
    ...
    <div class="p-20 bg-blue-new flex flex-row justify-evenly ">

        <div>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-28 w-28  " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
